...
void SCCB_GPIO_Config(void)
{
  ...
  GPIO_InitStructure.Mode = GPIO_MODE_OUTPUT_PP;		  //GPIO_Mode_AIN = 0x0,     //模拟输入
  GPIO_InitStructure.Speed =GPIO_SPEED_HIGH;		  //GPIO_Mode_IN_FLOATING = 0x04, //悬空输入
  HAL_GPIO_Init(GPIOA, &GPIO_InitStructure);				  //GPIO_Mode_IPD = 0x28,    //下拉输入
